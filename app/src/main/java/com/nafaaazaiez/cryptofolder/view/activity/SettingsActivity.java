...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    private static void sendFeedback(Context context) {
        ...
        intent.putExtra(Intent.EXTRA_EMAIL, new String[]{"youssefbenamor@gmail.com"});
    ...
    public static class MainPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(final Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_manual);
            ...
            Preference languagesList = findPreference("languages_list");
            languagesList.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
                    return false;
                }
